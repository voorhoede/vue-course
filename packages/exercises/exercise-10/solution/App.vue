...
export default {
  ...
  setup() {
    const forecast = ref([]);
    const locationButtonText = ref("Zoom to current location");
    ...
    const handleCurrentLocationClick = async () => {
      locationButtonText.value = "Loading...";
      ...
      locationButtonText.value = "Zoom to current location";
    };

    onMounted(async () => {
      forecast.value = await fetchDailyForecast();
    });
